...
local songData = { -- The main table that contains the songs you want credits on
    ...
    ['Bit-Beat'] = { -- This name NEEDS to be the name in the direct JSON/chart (e.g: dad-battle).
        ["songName"] = "Bit-Beat", -- The display name of the song.
        ["length"] = 4, -- The length the box is on screen.
        ["boxColor"] = "#000000", -- Color of Box (IN HEX).
        ["textColor"] = "#FFFFFF", -- Color of Text (IN HEX).
        ["credits"] = {
            ["Composer"] = "Stawii",
            ["Artist"] = "SA64ds, ShultzNG, FrenchOtter",
            ["Charter"] = "SA64ds",
        },
    },

    ['SORETRO (SA64 Cover)'] = { 
        ["songName"] = "SORETRO (SA64 Cover)", 
        ["length"] = 5, 
        ["boxColor"] = "#000000", 
        ["textColor"] = "#FFFFFF", 
        ["credits"] = { 
            ["Composer"] = "Gary Gilbenson",
            ["Cover"] = "SA64ds",
        },
    },
